...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $stmt = $pdo->prepare("INSERT INTO student (firstname,lastname,sharifname,direction,group) VALUES (?,?,?,?,?)");

        if($stmt->execute([ $firstname,$lastname,$sharifname,$direction,$group  ])) {
                $stmt = null;
