            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">Foydalanuvchilar Details</h2>
                    ...
                    $orderBy = array('id', 'name', 'login', 'password', 'status');
                    $order = 'id';
                    ...
                    if(!empty($_GET['search'])) {
                        ...
                        $sql = "SELECT * FROM user
                            WHERE CONCAT_WS (id,name,login,password,status)
                            LIKE '%$search%'
                            ORDER BY $order $sort
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
										...
										echo "<th><a href=?search=$search&sort=&order=name&sort=$sort>Ismi</th>";
										echo "<th><a href=?search=$search&sort=&order=login&sort=$sort>Login</th>";
										echo "<th><a href=?search=$search&sort=&order=password&sort=$sort>Parol</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                    echo "<td>" . $row['id'] . "</td>";echo "<td>" . $row['name'] . "</td>";echo "<td>" . $row['login'] . "</td>";echo "<td>" . $row['password'] . "</td>";echo "<td>" . $row['status'] . "</td>";
                                        echo "<td>";
