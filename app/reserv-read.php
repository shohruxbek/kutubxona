                ...
                <div class="col-md-8 mx-auto">
                    <div class="page-header">
                     ...
                     <div class="form-group">
                            ...
                            <p class="form-control-static"><?php echo $row["book_id"]; ?></p>
                        </div><div class="form-group">
                            <label>Band qilish sanasi</label>
                            <p class="form-control-static"><?php echo $row["bookdate"]; ?></p>
                        </div><div class="form-group">
                            <label>soni</label>
                    ...
                    <p><a href="reserv-index.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>
        </div>
    </section>
