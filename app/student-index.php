            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">Talabalar Details</h2>
                    ...
                    $orderBy = array('id', 'firstname', 'lastname', 'sharifname', 'direction', 'group');
                    $order = 'id';
                    ...
                    if(!empty($_GET['search'])) {
                        ...
                        $sql = "SELECT * FROM student
                            WHERE CONCAT_WS (id,firstname,lastname,sharifname,direction,group)
                            LIKE '%$search%'
                            ORDER BY $order $sort
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
										...
										echo "<th><a href=?search=$search&sort=&order=firstname&sort=$sort>Ismi</th>";
										echo "<th><a href=?search=$search&sort=&order=lastname&sort=$sort>Familiyasi</th>";
										echo "<th><a href=?search=$search&sort=&order=sharifname&sort=$sort>Sharifi</th>";
										echo "<th><a href=?search=$search&sort=&order=direction&sort=$sort>Yo'nalishi</th>";
										echo "<th><a href=?search=$search&sort=&order=group&sort=$sort>Guruhi</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                    echo "<td>" . $row['id'] . "</td>";echo "<td>" . $row['firstname'] . "</td>";echo "<td>" . $row['lastname'] . "</td>";echo "<td>" . $row['sharifname'] . "</td>";echo "<td>" . $row['direction'] . "</td>";echo "<td>" . $row['group'] . "</td>";
                                        echo "<td>";
