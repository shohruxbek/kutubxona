			...
			<div class="container-fluid">
				<div class="form-head d-flex mb-3 mb-md-4 align-items-start">
					<div class="mr-auto d-none d-lg-block">
						...
						<p class="mb-0 fs-18">Hurmatli talabalar SAMARQAND IQTISODIYOT VA SERVIS INSTITUTI Axborot resurs markazida bor kitoblarni hamda Axborot resurs markazidan olgan kitoblaringiz haqida malumot olishingiz mumkin
                   </p>
					</div>
